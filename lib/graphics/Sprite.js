...
var _Animatable = require('./components/Animatable');
 ...
 * @extends Object
*/
var Sprite = exports.Sprite = function (_GameObject) {
  ...
  function Sprite(id, x, y, w, h) {
    ...
    _this.attach(new _Collidable.CollidableSprite(_this));
    _this.attach(new _Animatable.Animatable(_this));
    _this.attach(new _Renderable.RenderableSprite(_this));
