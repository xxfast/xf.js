  ...
  */
  ...
  _createClass(SceneManager, [{
    ...
    value: function initialise() {
      var camera = new xf.Camera("default").transform(this.owner.size.width, this.owner.size.height).center();
      var scene = new xf.Scene("default", "#eaeaea").observe(camera);
      this.set(scene);
      return this;
    }
